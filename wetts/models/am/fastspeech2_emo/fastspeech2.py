...
from wetts.models.am.fastspeech2_emo.module import encoder
from wetts.models.am.fastspeech2_emo.module import variance_adaptor
from wetts.models.am.fastspeech2_emo.module import decoder
from wetts.models.am.fastspeech2_emo.module import postnet
from wetts.models.am.fastspeech2_emo.module import positional_encodings
from wetts.models.am.fastspeech2_emo.module import emotion_emb_net
...
class FastSpeech2(nn.Module):
    ...
    def __init__(self,
                 ...
                 n_enc_layer: int,
                 n_enc_head: int,
                 n_enc_conv_filter: int,
                 enc_conv_kernel_size: List[int],
                 enc_dropout: float,
                 n_vocab: int,
                 padding_idx: int,
                 n_va_conv_filter: int,
                 va_conv_kernel_size: int,
                 va_dropout: float,
                 pitch_min: float,
                 pitch_max: float,
                 pitch_mean: float,
                 ...
                 n_dec_layer: int,
                 n_dec_head: int,
                 n_dec_conv_filter: int,
                 dec_conv_kernel_size: int,
                 dec_dropout: float,
                 mel_dim: int,
                 n_speaker: int,
                 postnet_kernel_size: int,
                 postnet_hidden_dim: int,
                 n_postnet_conv_layers: int,
                 postnet_dropout: float,
                 max_pos_enc_len: int,
                 emotion_emb_dim=256) -> None:
        ...
        Args:
            ...
            emotion_emb_dim (int): dimension of emotion embedding.
        """
        super().__init__()
        ...
        self.emo_net = emotion_emb_net.EmotionEmbeddingNetwork(
            80, [32, 32, 64, 64, 128, 128], 3, 2, 128, 128, [128, 256, 256], 5)
    ...
    def forward(
        ...
        ref_mel_length: torch.IntTensor,
        ...
        Args:
            ...
            ref_mel (torch.Tensor): Reference melspectrogram.
            ref_mel_length (torch.IntTensor)
        ...
        emotion_emb, emotion_logit = self.emo_net(ref_mel, ref_mel_length)
        (variance_adaptor_output, mel_len, pitch_prediction, energy_prediction,
         log_duration_prediction) = self.variance_adaptor(
             enc_output, enc_output_mask, emotion_emb.unsqueeze(1),
             duration_target, pitch_target, energy_target, p_control,
             e_control, d_control)

        variance_adaptor_output = self.pos_enc(variance_adaptor_output)
        mel_mask = mask.get_padding_mask(mel_len)
        dec_output, _ = self.decoder(variance_adaptor_output, mel_mask,
        ...
        return (mel_prediction, postnet_mel_prediction, mel_mask, mel_len,
                ...
                enc_output_mask, emotion_emb, emotion_logit)
