...
class VariancePredictor(nn.Module):
    ...
    def __init__(self, input_dim, n_conv_filter, conv_kernel_size, dropout,
        ...
        self.linear1 = nn.Linear(emotion_emb_dim, input_dim)
    ...
    def forward(self, encoder_output, mask, emotion_emb):
        """
        encoder_output: (b,t,d)
        mask: (b,1,t)
        emotion_emb: (b,1,d)
        """
        encoder_output = encoder_output + self.linear1(emotion_emb)
