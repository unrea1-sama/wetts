...
class FastSpeech2Decoder(nn.Module):
    ...
    def __init__(self, dec_hidden_dim, n_dec_layer, n_dec_head,
        ...
        self.linear = nn.Linear(emotion_emb_dim, dec_hidden_dim)
    ...
    def forward(self, x, padding_mask, emotion_emb):
        """
        ...
        Args:
            ...
            emotion_emb: emotion embedding of shape (b,1,d)
        Returns:
