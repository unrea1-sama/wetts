...
class VarianceAdaptor(nn.Module):
    ...
    def __init__(self, input_dim: int, n_conv_filter: int,
                 ...
                 energy_sigma: float, n_pitch_bin: int, n_energy_bin: int,
                 emotion_emb_dim) -> None:
    ...
    def _get_embedding(
        ...
        """
        prediction = predictor(x, x_mask, emotion_emb)
    ...
    def forward(
        ...
        Args:
            ...
            emotion_emb (torch.Tensor): Emotion embedding. (b,1,d)
